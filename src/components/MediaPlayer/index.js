...
import { HeaderModular } from '../ui/HeaderModular'
...
export default class MediaPlayer extends React.Component {
	...
	async _loadNewPlaybackInstance(playing) {
		try {
			...
			console.log('erro ao sair da app')
		}
			...
			<>
				...
				<View style={styles.container}>
					<View style={styles.videoContainer}>
						...
						/>
						{!this.state.showVideo && this.PLAYLIST[this.index].image && (
							<View style={styles.imageContainer}>
								<Image
									source={
										typeof this.PLAYLIST[this.index].image === 'string'
											? {
													uri: this.PLAYLIST[this.index].image,
												}
											: this.PLAYLIST[this.index].image
									}
									style={styles.image}
									height={232.92}
									width={362.61}
